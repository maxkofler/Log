...
#define __WIN32_H__
		...
		#define LOGD(msg) hlog->log(Log::DE, __FUNCTION__, msg)
		#define LOGD(msg) hlog->log(Log::DW, __FUNCTION__, msg)
		#define LOGD(msg) hlog->log(Log::DI, __FUNCTION__, msg)
		...
		#define LOGD(msg) Log::Log::tryLog(Log::DE, __FUNCTION__, msg)
		#define LOGD(msg) Log::Log::tryLog(Log::DW, __FUNCTION__, msg)
		#define LOGD(msg) Log::Log::tryLog(Log::DI, __FUNCTION__, msg)
