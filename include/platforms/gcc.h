...
#define __GCC_H__
		...
		#define LOGD(msg) hlog->log(Log::DE, __PRETTY_FUNCTION__, msg)
		#define LOGD(msg) hlog->log(Log::DW, __PRETTY_FUNCTION__, msg)
		#define LOGD(msg) hlog->log(Log::DI, __PRETTY_FUNCTION__, msg)
		...
		#define LOGD(msg) Log::Log::tryLog(Log::DE, __PRETTY_FUNCTION__, msg)
		#define LOGD(msg) Log::Log::tryLog(Log::DW, __PRETTY_FUNCTION__, msg)
		#define LOGD(msg) Log::Log::tryLog(Log::DI, __PRETTY_FUNCTION__, msg)
